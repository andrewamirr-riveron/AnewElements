   ...
   function(record, search, https, runtime, url) {
     ...
     function autoCreateVendor(context) {
       ...
       try {
         ...
         opportunityStatus = opportunityRecord.getValue('entitystatus');
         AccoutingApproval = opportunityRecord.getValue('custbody_em_accounting_approval');
         ...
         buySale = opportunityRecord.getValue('custbody_fin_buy_or_sale');
         ...
         if (opportunityStatus == 13 && buySale == 1 && !vendorID && !existingPurchaseOrderID && AccoutingApproval == 2) {
           ...
           if (vendorExists == true) {
             ...
             if (parseFloat(opportunityNumberOfLines) > 0) {
               ...
               for (var k=0; k < opportunityNumberOfLines; k++) {
                 ...
                 var tax_code = opportunityRecord.getSublistValue({
                  sublistId: 'item',
                  fieldId: 'taxcode',
                  line: k
               }) || '';
                 ...
                 log.debug('Item tax code to set: ', tax_code);
           ...
           //--------------------------------------------------------------------//
         } else if (opportunityStatus == 13 && buySale == 1 && vendorID && !existingPurchaseOrderID && AccoutingApproval == 2) {
